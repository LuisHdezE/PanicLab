...
final class AppleOfficialKnowledgeViewModel: ObservableObject {
    ...
    private let facade = NativeEmbeddedAppleOfficialKnowledgeFacade()
...
struct AppleOfficialKnowledgeView: View {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    if let summary = viewModel.modelSummary {
                        ...
                        Label("No hay conocimiento auditado para el modelo seleccionado.", systemImage: "exclamationmark.triangle")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
                }
    ...
    private func capabilityCard(_ summary: NativeAppleKnowledgeModelSummary) -> some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            if let url = URL(string: summary.primaryOfficialUrl) {
